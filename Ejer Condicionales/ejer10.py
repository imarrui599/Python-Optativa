...
if pizza == 'si':
    ...
    print(' Has elegido una pizza vegetariana con tomate, mozzarella y ',ingrediente)
else:
    print('Los ingredientes son peperoni, jamon y salmon')
    ingrediente = input(' Elige un ingrediente: ')
    print(' Has elegido una pizza no vegetariana con tomate, mozzarella y ',ingrediente)
